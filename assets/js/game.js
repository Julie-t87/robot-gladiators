...
var shop = function() {
  ...
  var shopOptionPrompt = window.prompt("Would you liek to REFIL your health, UPGRADE your attack, or LEAVE the store? Please enter one: 'REFILL', 'UPGRADE', or 'LEAVE' to make a choice."
  );
  ...
  switch (shopOptionPrompt){
    ...
    case "UPGRADE":
      ...
      window.alert("You don;t ahve enought noney!");
    }
      break;
    case "leave": //new case
    case "LEAVE":
